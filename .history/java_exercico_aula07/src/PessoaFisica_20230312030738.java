public class PessoaFisica {
    ...
    private String calcularDigitoVerificador(String cpfSemDigito, int[] multiplicadores) {
        int total = 0;
        for (int i = 0; i < multiplicadores.length; i++) {
            total += Character.getNumericValue(cpfSemDigito.charAt(i)) * multiplicadores[i];
        }
        int resto = total % 11;
